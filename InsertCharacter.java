...
public class InsertCharacter extends Activity {
    ...
    public void onNext(View v){
    	...
    	if(name.equalsIgnoreCase("") || univ.equalsIgnoreCase("") || s_major.equalsIgnoreCase("")){        	
            ...
            if(name.equalsIgnoreCase("")){Toast.makeText(InsertCharacter.this, "이름을 입력하세요.", Toast.LENGTH_SHORT).show();}
            if(univ.equalsIgnoreCase("")){Toast.makeText(InsertCharacter.this, "대학교를 입력하세요.", Toast.LENGTH_SHORT).show();}
    ...
    public void onSetEvent(){
    		...
    		//추가남부일
    		  String e181 = " 이번달 19일은 학자금 추가납부기간입니다. " + "\n" + " 추가납부를 하시겠습니까? ";
    			  ...
    			  db3.execSQL("insert into event values(null,'e1', '1', '1', '" + e1 +"', '0','0');");  //새해
    			  db3.execSQL("insert into event values(null,'e2', '1', '28', '" + e2 +"', '0','0');"); //겨울여행  
    			  db3.execSQL("insert into event values(null,'e3', '1', '25', '" + e3 +"', '0','0');");  //토익 
    			  db3.execSQL("insert into event values(null,'e33', '3', '25', '" + e3 +"', '0','0');");  //토익
    			  db3.execSQL("insert into event values(null,'e34', '4', '25', '" + e3 +"', '0','0');");  //토익 
    			  db3.execSQL("insert into event values(null,'e37', '7', '25', '" + e3 +"', '0','0');");  //토익 
    			  db3.execSQL("insert into event values(null,'e39', '9', '25', '" + e3 +"', '0','0');");  //토익 
    			  db3.execSQL("insert into event values(null,'e311', '11', '25', '" + e3 +"', '0','0');");  //토익 
    			  db3.execSQL("insert into event values(null,'e4', '2', '7', '" + e4 +"', '0','0');");   //장학금
    			  db3.execSQL("insert into event values(null,'e5', '2', '13', '" + e5 +"', '0','0');");  //설날
    			  db3.execSQL("insert into event values(null,'e6', '3', '22', '" + e6 +"', '0','0');");  //생일
    			  db3.execSQL("insert into event values(null,'e7', '5', '7', '" + e7 +"', '0','0');");  //어버이날
    			  db3.execSQL("insert into event values(null,'e8', '6', '25', '" + e8 +"', '0','0');");  //중간고사 25~30
    			  db3.execSQL("insert into event values(null,'e9', '7', '10', '" + e9 +"', '0','0');");  //공모전
    			  db3.execSQL("insert into event values(null,'e10', '8', '28', '" + e10 +"', '0','0');");  //여름휴가
    			  db3.execSQL("insert into event values(null,'e11', '9', '22', '" + e11 +"', '0','0');");  //추석
    			  db3.execSQL("insert into event values(null,'e12', '10', '4', '" + e12 +"', '0','0');");  //이달의 직원
    			  db3.execSQL("insert into event values(null,'e13', '11', '16', '" + e13 +"', '0','0');");  //용돈
    			  db3.execSQL("insert into event values(null,'e14', '12', '7', '" + e14 +"', '0','0');");  //기말고사 12.7~12
    			  db3.execSQL("insert into event values(null,'e15', '12', '22', '" + e15 +"', '0','0');");  //구세군
    			  db3.execSQL("insert into event values(null,'e16', '12', '25', '" + e16 +"', '0','0');");  //크리스마스
    			  db3.execSQL("insert into event values(null,'e171', '1', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e172', '2', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e173', '3', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e174', '4', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e175', '5', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e176', '6', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e177', '7', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e178', '8', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e179', '9', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e1710', '10', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e1711', '11', '4', '" + e171 +"', '0','0');"); //학자금
    			  db3.execSQL("insert into event values(null,'e1712', '12', '4', '" + e171 +"', '0','0');"); //학자금  
    			  db3.execSQL("insert into event values(null,'e181', '4', '19', '" + e181 +"', '0','0');"); //학자금추가납부
    			  db3.execSQL("insert into event values(null,'e182', '8', '19', '" + e181 +"', '0','0');"); //학자금추가납부
    			  db3.execSQL("insert into event values(null,'e183', '11', '19', '" + e181 +"', '0','0');"); //학자금추가납부
